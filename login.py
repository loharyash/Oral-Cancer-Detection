...
title=tk.Label(root, text="Login Here", font=("SANS SERIFF", 25, "bold","italic"),bd=0,bg="WHITE",fg="DARK RED")
title.place(x=200,y=210,width=250)
        
Login_frame=tk.Frame(root,bg="WHITE")
Login_frame.place(x=200,y=300)
