...
root.title("Oral_cancer_detection") 


#430
#++++++++++++++++++++++++++++++++++++++++++++
#####For background Image
image2 =Image.open('o5.jpg')
...
#
lbl = tk.Label(root, text="Oral_cancer_detection", font=('times', 30,' bold '), width=65,height=1,bg="Red3",fg="white")
lbl.place(x=0, y=0)



frame_alpr = tk.LabelFrame(root, text="PROCESS", width=220, height=350, bd=5, font=('times', 14, ' bold '),bg="RED")
frame_alpr.grid(row=0, column=0, sticky='nw')
frame_alpr.place(x=30, y=450)
...
def test_model_proc(fn):
    ...
    if fn!="":
        ...
        if yoga == 0:
           ...
           Cd="gangivostomatitis"
        elif yoga == 3:
            Cd="mouth cancer"
        elif yoga == 4:
            Cd="oral cancer"
        elif yoga == 5:
            Cd="oral lichen planus"
        elif yoga == 6:
            Cd="oral thrush"
        elif yoga == 7:
            Cd="normal"
...
def openimage():
    ...
    global fn
    print(fn)
    fileName = askopenfilename(initialdir='E:/project 2023\Oral_cancer_project', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
